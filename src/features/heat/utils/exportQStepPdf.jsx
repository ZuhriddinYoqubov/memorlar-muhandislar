...
export const QStepPages = ({ initial, climate, heatingSeason, qStepData, layers }) => {
  ...
  const roofTypeLabels = {
    tomyopma: "Tomyopma",
    ochiq_chortoq: "Ochiq chordoq",
    chortoq_orayopmasi: "Chordoq orayopmasi",
  };
  const roofTypeLabel = roofTypeLabels[roofType] || roofType || "—";
    ...
    <>
      <Page size="A4" style={pdfStyles.page}>
        ...
        <View style={pdfStyles.pageContent}>
          ...
          {/* Bino to'suvchi konstruksiyalari */}
          ...
          {/* Tashqi devorlarning maydoni (net) */}
          <View style={pdfStyles.row}>
            <View style={pdfStyles.labelWithSubscript}>
          ...
          {/* Derazalar va vitrinalar maydoni */}
          <View style={pdfStyles.row}>
            <View style={pdfStyles.labelWithSubscript}>
          ...
          {/* Yerdagi pol hamda yer sathidan pastdagi devorlar maydoni */}
          <View style={pdfStyles.row}>
            <View style={pdfStyles.labelWithSubscript}>
          ...
          {/* Isitilmaydigan yerto'la ustidagi pol maydoni */}
          <View style={pdfStyles.row}>
            <View style={pdfStyles.labelWithSubscript}>
...
const QStepPdfDocument = ({ initial, climate, heatingSeason, qStepData, layers }) => (
  <Document>
    <QStepPages
      initial={initial}
      climate={climate}
...
export async function exportQStepPdfReact({ initial, climate, heatingSeason, qStepData, layers }) {
  try {
